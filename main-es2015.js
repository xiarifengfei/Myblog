...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<!-- <ngb-alert *ngIf=\"alertService.globalBannerType\" [type]=\"alertService.globalBannerType\" (close)=\"close(alert)\">{{ alertService.globalBannerMessage }}</ngb-alert> -->\n<div class=\"alert alert-success\">\n        <strong>Success!</strong> Indicates a successful or positive action.\n      </div>");
...
/* harmony import */ var _common_services_constants_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./common/services/constants.service */ "./src/app/common/services/constants.service.ts");
/* harmony import */ var _common_services_global_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./common/services/global.service */ "./src/app/common/services/global.service.ts");
/* harmony import */ var _common_alert_alert_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./common/alert/alert.component */ "./src/app/common/alert/alert.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _common_alert_alert_component__WEBPACK_IMPORTED_MODULE_22__["AlertComponent"]
        ],
        imports: [
            ngx_bootstrap__WEBPACK_IMPORTED_MODULE_13__["AlertModule"].forRoot(),
            ngx_markdown__WEBPACK_IMPORTED_MODULE_16__["MarkdownModule"].forRoot({ loader: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClient"] }),
        ...
        providers: [
            _common_services_global_service__WEBPACK_IMPORTED_MODULE_21__["GlobalService"],
            _common_services_constants_service__WEBPACK_IMPORTED_MODULE_20__["ConstantsService"],
...
/* harmony import */ var _article_serve__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./article.serve */ "./src/app/article-detail/article.serve.ts");
/* harmony import */ var _common_services_global_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/services/global.service */ "./src/app/common/services/global.service.ts");
...
let ArticleDetailComponent = class ArticleDetailComponent {
    constructor(articleServeh, router, httpClient, globals) {
    ...
    getArticle(id) {
        this.articleServeh.getArticle(id).subscribe(data => {
            this.article = data.article;
    ...
    createnarticle() {
        ...
        this.articleServeh.createArticle(this.article).subscribe(data => {
    ...
    updateArticle() {
        this.articleServeh.updateArticle(this.article).subscribe(data => {
            this.message = data.success;
        });
    }
};
...
let articleServe = class articleServe {
    ...
    updateArticle(article) {
        return this.httpClient
            .put(`${_config_config__WEBPACK_IMPORTED_MODULE_2__["webconfig"].backendurl}${this.URL.base}/${article._id}`, article, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('update atricle', false)));
    }
    createArticle(article) {
        return this.httpClient
            .post(`${_config_config__WEBPACK_IMPORTED_MODULE_2__["webconfig"].backendurl}${this.URL.base}/${this.URL.create}`, article, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('update atricle', false)));
    }
    getArticle(id) {
        return this.httpClient
            .get(`${_config_config__WEBPACK_IMPORTED_MODULE_2__["webconfig"].backendurl}${this.URL.base}/${id}`, httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('update atricle', false)));
    }
};
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_global_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/global.service */ "./src/app/common/services/global.service.ts");
...
AlertComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-alert',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./alert.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/alert/alert.component.html")).default,
        providers: [_services_global_service__WEBPACK_IMPORTED_MODULE_2__["GlobalService"]],
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./alert.component.css */ "./src/app/common/alert/alert.component.css")).default]
    })
], AlertComponent);
...
let UserComponent = class UserComponent {
    ...
    loginIni() {
        this.userServeh.checkLoginstatus().subscribe(response => {
            if (response.success) {
    ...
    onSubmit() {
        this.model = new _user__WEBPACK_IMPORTED_MODULE_2__["user"](this.model.name, this.model.password);
